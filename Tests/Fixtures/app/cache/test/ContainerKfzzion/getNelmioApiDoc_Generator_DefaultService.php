...
$this->services['nelmio_api_doc.generator.default'] = $instance = new \Nelmio\ApiDocBundle\ApiDocGenerator(new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['nelmio_api_doc.describers.config']) ? $this->services['nelmio_api_doc.describers.config'] : ($this->services['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber([]))) && false ?: '_'};
    yield 1 => ${($_ = isset($this->services['nelmio_api_doc.describers.config.default']) ? $this->services['nelmio_api_doc.describers.config.default'] : ($this->services['nelmio_api_doc.describers.config.default'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber([], true))) && false ?: '_'};
