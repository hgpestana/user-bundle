...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[5].'/Entity')]), 'HGPestana\\UserBundle\\Entity');

$a->setEntityNamespaces(['HGPestanaUserBundle' => 'HGPestana\\UserBundle\\Entity']);
